...
--%>
<%@page import="com.starsea.im.biz.entity.e.PageParam"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<%
  request.setAttribute("domain", "http://localhost:8080/e/");
%>
...
<head>
  ...
  <title>E+</title>
  <link rel="stylesheet" type="text/css" href="../../../static/css/e/index.min.css">
</head>
<body>
    ...
    <div id="post-2" class="post-2 page type-page status-publish hentry">
      ...
      <div class="entry entry-content">
        ...
        <div id="list">
          ...
          %><a href="starsea/e/ren.html?page=<%=i %>"><%=i %></a><%
              }
            }
          %>
            <span>页</span>
